...
using NetCoreMicroserviceSample.Repositories.InMemory;
using Serilog;
using System;
...
namespace NetCoreMicroserviceSample.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // use in memory DB as singleton - "real" database systems should/could be integrated as transient dependencies
